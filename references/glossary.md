**Inductive bias** (learning bias) is the set of assumptions of the learner (model) to predict outputs. E.g., the parameters learned on the training data as well as the prior assumptions.
